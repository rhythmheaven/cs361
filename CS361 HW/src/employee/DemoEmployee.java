...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI(); // prints PART TIME EMPLOYEE because the object is part time from being inherited 
		//allowing it to run its child method.
		// emp3.getHourlyRate(); // returns syntax error because it is still referred to as an Employee 
		// so it is trying to look for Employee's methods only.
		...
		// because Employee couldn't be casted to since it is general and doesn't have the 
		// info necessary for downcasting.
